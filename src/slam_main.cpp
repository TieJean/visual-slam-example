...
int main() {
    if (1) {
        ...
        camera_to_world.translate(Vector3f(0.000000, 0.000000, -20.000000));
        camera_to_world.rotate(Quaternionf(1, 0, 0, 0));
        ...
        camera_to_world = Affine3f::Identity();
        camera_to_world.translate(Vector3f(0.000000, 0.000000, -18.500000));
        camera_to_world.rotate(Quaternionf(1, 0, 0, 0));
        world_to_camera = camera_to_world.inverse();
        Quaternionf angle2(camera_to_world.rotation());
        Vector3f loc2(camera_to_world.translation());
